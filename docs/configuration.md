...
* `parser` : Pick the parser that matches the file structure of your sequence files. We currently support [miseq v26](parsers/miseq_v26.md), [miseq v31](parsers/miseq_v31.md), [nextseq](parsers/nextseq.md), [nextseq2k](parsers/nextseq2k_nml.md), [directory](parsers/directory.md) and [miniseq](parsers/miniseq.md).
