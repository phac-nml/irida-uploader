...
from iridauploader.parsers.exceptions import DirectoryError, ValidationError
...
class TestGetSequencingRun(unittest.TestCase):
    ...
    def test_invalid_sample_sheets(self):
        ...
        :return:
        """
        sample_sheet = path.join(path_to_module, "invalid_sample_sheet", "UploadList.csv")
    ...
    def test_valid_run(self):
        ...
        :return:
        """
        sample_sheet = path.join(path_to_module, "fake_ngs_data", "UploadList.csv")
