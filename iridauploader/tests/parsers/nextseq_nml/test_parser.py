...
class TestFindRuns(unittest.TestCase):
    ...
    def test_find_one_of_three(self):
        ...
        res = Parser(sample_sheet_override='SampleSheetClassic.csv').find_runs(directory)
...
class TestFindSingleRun(unittest.TestCase):
    ...
    def test_find_in_dir_with_three_dirs(self):
        ...
        res = Parser(sample_sheet_override='SampleSheetClassic.csv').find_single_run(directory)
...
class TestGetSampleSheet(unittest.TestCase):
    ...
    def test_valid_directory(self):
        ...
        """
        directory = path.join(path_to_module, "three_dirs", "first")
        file_path = path.join(directory, "SampleSheetClassic.csv")

        res = Parser(sample_sheet_override='SampleSheetClassic.csv').get_sample_sheet(directory)
    ...
    def test_no_sheet_in_directory(self):
        ...
        with self.assertRaises(DirectoryError) as context:
            Parser(sample_sheet_override='SampleSheetClassic.csv').get_sample_sheet(directory)
...
class TestGetSequencingRun(unittest.TestCase):
    ...
    def test_invalid_sample_sheets(self):
        ...
        :return:
        """
        sample_sheet = path.join(path_to_module, "invalid_sample_sheet", "SampleSheetClassic.csv")

        with self.assertRaises(ValidationError) as context:
            Parser(sample_sheet_override='SampleSheetClassic.csv').get_sequencing_run(sample_sheet)
    ...
    def test_valid_run(self):
        ...
        :return:
        """
        sample_sheet = path.join(path_to_module, "fake_nextseq_run", "SampleSheetClassic.csv")

        res = Parser(sample_sheet_override='SampleSheetClassic.csv').get_sequencing_run(sample_sheet)
