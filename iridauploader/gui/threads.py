...
class UploadThread(QtCore.QThread):
    ...
    def __init__(self):
        ...
        self._upload_as_assemblies = False
        self._exit_return = None

    def set_vars(self, run_dir, force_state, upload_as_assemblies):
        """
        Sets the variables in the object to the ones passed in
        :param run_dir:
        :param force_state:
        :param upload_as_assemblies
        :return:
        """
        self._run_dir = run_dir
        self._force_state = force_state
        self._upload_as_assemblies = upload_as_assemblies
